    ...
    return (
      ...
      <div className="container flex justify-between h-16 mx-auto">
        ...
        <ul className="items-stretch hidden space-x-3 lg:flex">
            <li className="flex">
              <NavLink to='/profile' className={handleClass}>Profile</NavLink>
            </li>
            <li className="flex">
              <NavLink to='/blog' className={handleClass}>Blog</NavLink>
            </li>
            {user.data.roles.includes(import.meta.env.VITE_REACT_APP_MOD_CODE) ?
            <li className="flex">
              <NavLink  to='/mod' className={handleClass}>Mod</NavLink>
            </li> :
            null
            }
            {user.data.roles.includes(import.meta.env.VITE_REACT_APP_ADMIN_CODE) ?
            <li className="flex">
              <NavLink  to='/admin' className={handleClass}>Admin</NavLink>
            </li> :
            null
            }
        </ul>
        <div className="items-center flex-shrink-0 hidden lg:flex">
          <NavLink to='/logout' className="self-center px-8 py-3 rounded hover:underline">Log Out</NavLink>
        </div>
    ...
    <nav className="bg-white dark:bg-gray-900 w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
      ...
      <NavLink to='/' className="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <div className="flex items-center lg:order-2">
            ...
            <button type="button" data-dropdown-toggle="notification-dropdown"
              className="hidden lg:flex text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
            ...
            <button data-collapse-toggle="mobile-menu-2" type="button" className="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
                <span className="sr-only">Open main menu</span>c
      ...
      <div className="items-center justify-between hidden w-full lg:flex md:w-auto md:order-1" id="navbar-sticky">
        <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          ...
          <li>
            <NavLink to="/blog" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Blog</NavLink>
          </li>
        </ul>
      </div>
      </div>
